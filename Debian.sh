...
sudo apt update
sudo apt install -y zsh neofetch nginx git ranger bat tldr apt-transport-https ca-certificates curl gnupg2 software-properties-common fd-find zoxide duf lsd btop
